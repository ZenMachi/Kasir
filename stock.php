                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" class="btn btn-warning mb-4 text-white" data-bs-toggle="modal" data-bs-target="#edit<?=$idproduk;?>">
                                                Edit
                                                </button>
                                                <td><button type="button" class="btn btn-danger text-white" data-bs-toggle="modal" data-bs-target="#hapus<?=$idproduk;?>">
                                                Delete
                                                </button></td>
                                        </tr>
                                    ...
                                    <!-- Modal delete -->
                                    <div class="modal fade" id="hapus<?=$idproduk;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Ubah <?=$namaproduk;?></h5>
